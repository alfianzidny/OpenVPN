...
rm -rv /hdd/LimeVPN >/dev/null 2>&1
...
mv "/hdd/New OpenVPN" LimeVPN
cd /hdd/LimeVPN &> /dev/null 2>&1
...
init 4
sleep 3
sed -i '$i config.vpnmanager.directory=/hdd/LimeVPN/' /etc/enigma2/settings
